...
import type { BrewAsset, CampaignMapMarker, CampaignMapRecord, CampaignMapRoom, Encounter } from '../types';
...
type Props = {
  ...
  onLinkRoom: (map: CampaignMapRecord, roomId: string) => void;
...
export function MapsPanel({ maps, assets, encounters, selectedId, onSelect, onCreate, onSave, onDelete, onInsert, onLinkRoom, onUploadImage }: Props) {
